...
contract AbstractFundStorage is IAbstractFundStorage, Initializable {
  ...
  bytes32 public constant ROLE_BURN_LOCK_MANAGER = bytes32("BURN_LOCK_MANAGER");
  bytes32 public constant ROLE_TRANSFER_REPUTATION_MANAGER = bytes32("TRANSFER_REPUTATION_MANAGER");
